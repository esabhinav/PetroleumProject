...
public class OldReadExcelDealer 
{
	...
	public static void main(String[] args) 
	{
		try
		{
			...
			while (rowIterator.hasNext()) 
			{
				...
				try {
					...
					System.out.println("district:"+panneer.getDistrict() + ":SUPPLY LOC :"+panneer.getSupplyLocation() + ":  TERR :"+panneer.getTerriority());
		...
		//	DealerDAOImpl dao = new DealerDAOImpl();
		 	...
		 	// dao.insertAllDealer(dealerList);
