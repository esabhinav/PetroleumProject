 ...
 */
@WebServlet("/gst")
public class GSTController extends HttpServlet implements TNBPDAConstants{
	...
	protected void doPost(HttpServletRequest request,
		...
		case 1: // insertQuestion
			...
			List<Question> listQuestion = forumDAO.insertQuestion(question);
		...
		case 4: // view question.
			...
			question = forumDAO.readQuestion(question);
			System.out.println("Qeustion "+question.getAnswerList().size());
			session.setAttribute(QUESTION, question);
			targetPage="/jsp/forum/list.jsp";
			break;
