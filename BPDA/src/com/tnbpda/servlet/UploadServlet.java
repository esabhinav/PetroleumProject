...
public class UploadServlet extends HttpServlet {
   ...
   Dealer user = (Dealer) session.getAttribute(TNBPDAConstants.AUTH_USER); 
     ...
     // factory.setRepository(new File("D:\\RVT\\upload\\"));
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
               ...
               // Write the file
               int ccNo = user.getCcNo(); 
               String ext = fileName.substring(fileName.indexOf("."));
               
               file = new File(filePath+ccNo+ext);
             ...
             /*  if( fileName.lastIndexOf("\\") >= 0 ) {
               ...
               String s = "Uploaded Filename: " + fileName + "<br>";
               session.setAttribute("str", s);
				System.out.println(s);
				targetPage = "/jsp/dealer/uploadsuccess.jsp";
