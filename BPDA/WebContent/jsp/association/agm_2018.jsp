	...
	<div id="main_container">
		...
		<div id="main_content">
			<table cellpadding="5" cellspacing="5" border="1" width="100%">
				...
				<tr><td colspan="4"> <b>AGM Meeting</b></td></tr>
				<tr>
					<td width="300"><img  width="300" height="300"
						src="<%=request.getContextPath()%>/images/agms/DSC_0025.JPG"></td>
					<td width="300"><img width="300" height="300" 
						src="<%=request.getContextPath()%>/images/agms/DSC_0031.JPG"></td>
					<td width="300"><img   width="300" height="300"
...
<%-- 
		<jsp:include  page="<%=request.getContextPath()%>/jsp/menu/footer.jsp" /> --%>
	</div>
