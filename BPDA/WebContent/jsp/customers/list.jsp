			...
			<div id="main_content">
				<table border="1" width="100%">
					...
					<tr>
						...
						<td><br />
							<center>List out all customers details.</center>
							<table cellpadding="5" cellspacing="5" width="100%" id="myTable">
								<thead>
									<tr align="left">
										...
										<th width="10%">Dealer Comments</th>
								...
								<%
									if (customerList != null)
										...
										//	if (customer.getStatus().equals("C")) { // this display all completed satus
								%>
								...
								<tr>
									...
									<td><%=customer.getApproverComments()%></td>

									<td><%=customer.getStatus()%></td>
									<%
										if (userList.contains("" + user.getCcNo())
															|| user.getCcNo() == customer.getCcNo()) {
									%>
									<td><a
										href="<%=request.getContextPath()%>/customer?option=3&l=c&cid=<%=customer.getCid()%>">Edit</a></td>
									<td><a
